    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAffichage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Matricule",textMatricule.getText().toString());
                intent.putExtra("Nom",textNom.getText().toString());
                intent.putExtra("Prenom",textPrenom.getText().toString());
                intent.putExtra("Sexe",sexeSelected);
                intent.putExtra("EtatCivil",etatCivilSelected);
                intent.putExtra("Langue",langue);
                intent.putExtra("Salaire",salaire.getText().toString());
